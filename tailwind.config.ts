  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        ...
        display: ["Pacifico", "Quicksand", "system-ui", "cursive"],
      ...
      backgroundImage: {
        ...
        "tiwill-gradient": "linear-gradient(135deg, hsl(var(--tiwill-pink)), hsl(var(--tiwill-purple)), hsl(var(--tiwill-blue)))",
        "tiwill-sunset": "linear-gradient(135deg, hsl(var(--tiwill-orange)), hsl(var(--tiwill-pink)), hsl(var(--tiwill-purple)))",
      },
    },
  },
